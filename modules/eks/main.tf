...
# --- Cluster OIDC provider (required for IRSA — lets cluster addons like
# the EBS CSI driver assume an IAM role via a Kubernetes service account,
# instead of inheriting the node's own IAM role) ---
...
# --- EBS CSI driver addon (required to provision PersistentVolumes —
# EKS does not include this by default, and the older in-tree
# kubernetes.io/aws-ebs provisioner used by a plain gp2 StorageClass does
# not work without it either) ---
